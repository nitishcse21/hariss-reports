...
#     if gran == "weekly":
#         return (
#             "CAST(DATE_TRUNC('week', ih.invoice_date) AS DATE)",
#             "CONCAT(TO_CHAR(DATE_TRUNC('week', ih.invoice_date), 'DD Mon'), ' - ', "
#             "TO_CHAR(DATE_TRUNC('week', ih.invoice_date) + INTERVAL '6 day', 'DD Mon'))"
#         )

#     # Monthly format: Jan-2024
#     if gran == "monthly":
#         return (
#             "CAST(DATE_TRUNC('month', ih.invoice_date) AS DATE)",
...
#     if gran == "yearly":
#         return (
#             "CAST(DATE_TRUNC('year', ih.invoice_date) AS DATE)",
