...
from sales_report.utils.common_helper import build_query_parts, validate_mandatory
from database import engine
from sales_report.utils.dashboard_helper import ensure_warehouse_join, choose_granularity


app = APIRouter()


@app.post("/sales-dashboard")
