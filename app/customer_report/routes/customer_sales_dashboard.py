...
from app.customer_report.utils.customer_common_helper import build_query_parts, validate_mandatory
from app.customer_report.utils.customer_sales_dashboard_helper import choose_granularity, customer_level_filter
import time

router = APIRouter()

@router.post("/customer-sales-dashboard")
